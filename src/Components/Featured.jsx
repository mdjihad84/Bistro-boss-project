const FeaturedSection = ({ imageSrc, subtitle, title, description, buttonText }) => {
    return (
        <div className="py-8">
            ...
            <div className="relative sm:absolute w-full max-w-[1096px] h-[300px] mx-auto sm:top-1/2 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:-translate-y-1/2 flex flex-col md:flex-row items-center justify-center">
                ...
                <div className="w-full md:w-[740px] mt-4 md:mt-0 md:ml-6 px-2 sm:px-4">
                    ...
                    <button className="btn mt-3 sm:mt-4 border-none bg-transparent text-xs sm:text-sm md:text-base lg:text-xl text-white border border-2 border-solid hover:bg-[#D99904]">
                        {buttonText}
                    </button>
                </div>
            </div>
